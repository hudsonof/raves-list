...
const SignIn: NextPage = () => {
    ...
    return (
        <>
            <Head>
                <title>Login - Raves List</title>
            </Head>

            <main className="mx-auto flex min-h-screen w-full items-center justify-center">
                <div className="absolute top-5 right-5">
                    <button className="btn mr-5" onClick={handleBackToHome}>Voltar</button>
                </div>
                <section className="flex w-[30rem] flex-col space-y-10">
                    <div className="text-center text-4xl font-medium">
                        <Image src="/ohm-white.svg" alt="Raves List" width={100} height={100} />
                        <p className="pt-5">Raves List</p>
                    </div>

                    <button onClick={handleSignInGoogle} aria-label="Continue with google" role="button" className="btn">
                        ...
                        <p className="text-base font-medium ml-4">Continuar com Google</p>
                    </button>
                    ...
                    <div className="relative flex items-center justify-center w-full transform border-b-2 bg-transparent text-lg duration-300 focus-within:border-indigo-500">
                        <input id="password" type={passwordType} placeholder="Senha" className="w-full border-none bg-transparent outline-none placeholder:italic focus:outline-none" />
                        <div className="absolute right-0 mt-2 mr-3 cursor-pointer" onClick={handleShowPassword}>
                    ...
                    <a href="#" className="transform text-center font-semibold text-gray-500 duration-300 hover:text-gray-300">Esqueceu a senha?</a>
